package org.springmongo.controller;
...
import org.springmongo.service.PersonService;
import org.springmongo.test.model.Person;
...
public class PersonController {
	...
	public View createPerson(@ModelAttribute Person person, ModelMap model) {
		...
		return new RedirectView("/spring-mongodb-test/person");
	}
